...
import { OpenForCollectionCard } from "@/components/open-for-collection-card";
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
            {visibleSections.map((section) => {
              ...
              return (
                <div
                  key={section.id}
                  className={section.id === "recentEntries" || section.id === "settlementsDue" || section.id === "openForCollection" ? "lg:col-span-2" : undefined}
                >
                  {node}
                </div>
              );
