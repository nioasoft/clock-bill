...
interface GoogleSignInButtonProps {
  ...
  callbackURL?: string;
  /** Externally disable the button (e.g. until terms consent is given). */
  disabled?: boolean;
}
 ...
 */
export function GoogleSignInButton({ label, callbackURL = "/dashboard", disabled = false }: GoogleSignInButtonProps) {
